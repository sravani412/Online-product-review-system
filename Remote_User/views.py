...
def Detect_Product_Review_Type(request):
    if request.method == "POST":
        ...
        fraud_prediction.objects.create(Product_Review=review,Prediction=val)

        return render(request, 'RUser/Detect_Product_Review_Type.html',{'objs': val})
    return render(request, 'RUser/Detect_Product_Review_Type.html')
